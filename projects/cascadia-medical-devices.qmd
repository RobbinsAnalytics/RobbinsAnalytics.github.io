...
image: https://www.robbinsanalytics.com/assets/thumb-medical-devices.png
...
::: {.arch-container}
![Cascadia end-to-end data platform](../assets/cascadia_analytics_tech_stack.svg){fig-alt="Architecture diagram: SQL Server source systems feed a Microsoft Fabric medallion lakehouse — Bronze, Silver, Gold — which is surfaced through a Power BI Direct Lake semantic model."}
:::
...
![The manufacturing analytics report — Power BI. OEE, FPY, and OTIF headline cards; availability / performance / OEE by production line; FPY by month and station (the declining station drives the root-cause story); a downtime Pareto by reason code; and OTIF by customer.](../assets/cascadia-medical-devices-page1.png){fig-alt="Power BI report page. A row of headline cards for OEE, first-pass yield and on-time-in-full; bar charts of availability, performance and OEE by production line; first-pass yield by month and station, with one station visibly declining; a downtime Pareto by reason code; and on-time-in-full by customer."}
...
- [Architecture Explainer](https://github.com/RobbinsAnalytics/manufacturing-analytics/blob/main/docs/02_source_sql_layer.md) — schema design decisions and data dictionary
