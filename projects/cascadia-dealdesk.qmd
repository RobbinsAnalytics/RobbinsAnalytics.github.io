...
image: https://robbinsanalytics.github.io/assets/thumb-dealdesk.png
...
[Agreement vs. Quoted Price](https://robbinsanalytics.github.io/cascadia-dealdesk/){.btn .btn-primary}
[Customer Pricing & Margin](https://robbinsanalytics.github.io/cascadia-dealdesk/customer.html){.btn .btn-primary}
...
- **`chart-review.md`** — a scored pass/fail review of all eleven charts against my published visualization design system, including the checks that failed on the first pass and what changed. Several titles claimed figures a reader could not verify from the plot, and those charts were rebuilt rather than re-worded.
...
[Open the Exception Page →](https://robbinsanalytics.github.io/cascadia-dealdesk/){.btn .btn-primary}
...
[Open the Customer Page →](https://robbinsanalytics.github.io/cascadia-dealdesk/customer.html){.btn .btn-primary}
...
- [Agreement vs. Quoted Price](https://robbinsanalytics.github.io/cascadia-dealdesk/) — the exception report, with the materiality threshold control
- [Customer Pricing & Margin](https://robbinsanalytics.github.io/cascadia-dealdesk/customer.html) — one customer over a period, and the agreement timeline
