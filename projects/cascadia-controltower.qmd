...
[Fill Rate & Split Cost](https://www.robbinsanalytics.com/cascadia-controltower/){.btn .btn-primary}
...
- [Fill Rate & Split Cost](https://www.robbinsanalytics.com/cascadia-controltower/) — seven charts, the certified metric register, and the realism audits
- [Build Repository](https://github.com/RobbinsAnalytics/cascadia-controltower) — generator, dbt project, validation suite, and the governance documents
