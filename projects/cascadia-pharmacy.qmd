...
image: https://www.robbinsanalytics.com/assets/thumb-pharmacy.png
...
- CDC VaxView: [Centers for Disease Control and Prevention](https://www.cdc.gov/adultvaxview/) — public domain federal data.
...
![GLP-1 Growth page — Power BI. KPI cards for cumulative spend, YoY growth, beneficiaries, and cost per beneficiary; spend trend 2020–2023; brand-level breakdown; and a suppressed-data disclosure so totals stay honest.](../assets/cascadia-pharmacy-glp1.png){fig-alt="Power BI report page. KPI cards for cumulative GLP-1 spend, year-over-year growth, beneficiary count and cost per beneficiary; a spend trend line from 2020 to 2023 rising steeply; a brand-level breakdown bar chart; and a disclosure panel stating how suppressed rows are handled."}
