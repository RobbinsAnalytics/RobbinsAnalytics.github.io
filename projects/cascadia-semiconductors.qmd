...
image: https://robbinsanalytics.github.io/assets/thumb-finance.png
...
**Beyond the frozen phases — a Q2 FY2026 read-through.** When FormFactor announced Q2 on July 29, 2026, I applied the same margin-walk method to the announced figures; because those come from an 8-K press-release exhibit and aren’t XBRL-tagged, the page sits deliberately outside the frozen dataset and labels every figure as *filed* or *announced* until the 10-Q lands.

[Open the Q2 Read-Through →](https://robbinsanalytics.github.io/cascadia-semiconductors/q2-readthrough.html){.btn .btn-primary}
...
- [Q2 FY2026 Read-Through](https://robbinsanalytics.github.io/cascadia-semiconductors/q2-readthrough.html) — the July 29 earnings run through the Phase 2 margin walk, outside the frozen dataset (press-release tier, not yet XBRL)
