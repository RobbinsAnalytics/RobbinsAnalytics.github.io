...
# renamed to match its narrowed Finance scope. Quarto renders a real redirect
# document at the old path, so previously shared links keep working.
aliases:
